...
<script>
  ...
  export default defineComponent({
    ...
    rechazar(obs){
     ...
     axios.post('https://www.ssarica.cl/app/rechazarot.php',d,{headers: { 'Content-Type': 'multipart/form-data'}}).then(response=>{
      console.log(response)
   ...
   aprobar(){
      ...
      axios.post('https://www.ssarica.cl/app/aprobarcc.php',d,{headers: { 'Content-Type': 'multipart/form-data'}}).then(response=>{
        console.log(response)
